...
try:
    ...
    load_dotenv()  # loyiha papkasidagi .env faylni avtomatik o'qiydi (agar mavjud bo'lsa)
except ImportError:
    pass
...
if not BOT_TOKEN:
    raise SystemExit(
        "❌ BOT_TOKEN topilmadi. Uni .env faylga yoki muhit o'zgaruvchisi sifatida bering.\n"
        "Hech qachon tokenni to'g'ridan-to'g'ri kodga yozib, GitHub'ga yubormang!"
    )
